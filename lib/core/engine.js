...
var previewRender=handlebars.compile(fs.readFileSync('./core/preview.hbs',{encoding:'utf-8'})),
    jsxRender=handlebars.compile(fs.readFileSync('./core/jsx.hbs',{encoding:'utf-8'}));
